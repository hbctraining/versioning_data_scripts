...
3. Download the [workshop sample files zipped folder](https://github.com/hbctraining/versioning_data_scripts/blob/master/data/example_files.zip) and unzip it.
